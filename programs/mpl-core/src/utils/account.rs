...
pub(crate) fn close_program_account<'a>(
    ...
    **funds_dest_account_info.try_borrow_mut_lamports()? = new_dest_lamports;
    ...
    let new_account_lamports = account_starting_lamports
    ...
    **account_to_close_info.try_borrow_mut_lamports()? = new_account_lamports;
    ...
    let key_u8 = Key::Uninitialized.to_u8().ok_or(MplCoreError::NumericalOverflowError)?;
    account_to_close_info.try_borrow_mut_data()?[0] = key_u8;
...
pub(crate) fn resize_or_reallocate_account<'a>(
    ...
    if new_minimum_balance >= current_minimum_balance {
        ...
        let new_funding_lamports = funding_lamports
            ...
            .ok_or(crate::error::MplCoreError::NumericalOverflowError)?;
