...
pub(crate) fn close_program_account<'a>(
    ...
    **funds_dest_account_info.lamports.borrow_mut() = dest_starting_lamports
    ...
    let current_account_lamports = account_to_close_info.lamports();
    let new_account_lamports = current_account_lamports
...
pub(crate) fn resize_or_reallocate_account<'a>(
    ...
    if new_minimum_balance >= current_minimum_balance {
        ...
        let new_funding_lamports = current_funding_lamports
        ...
        **funding_account.try_borrow_mut_lamports()? = new_funding_lamports;
        ...
        let new_target_lamports = current_target_lamports
